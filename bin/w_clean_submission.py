...
# Filter for Women's Teams 
sub_df = sub_df[sub_df["TeamA"] >= 3000]
sub_df = sub_df[sub_df["TeamB"] >= 3000]

# Filter for this season
sub_df = sub_df[sub_df["Season"] == 2026].reset_index(drop=True)
...
feature_df.to_csv("clean_data/w_2026_submission_features.csv", index=False)
