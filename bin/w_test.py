...
with open("models/WM-2026-LogReg.pkl", "rb") as f:
    logreg_model = pickle.load(f)

with open("models/WM-2026-XGBoost.pkl", "rb") as f:
    xgb_model = pickle.load(f)

# 2. Load the preprocessed 2026 women's submission features
sub_df = pd.read_csv("clean_data/w_2026_submission_features.csv")
...
submission.to_csv("w_submission.csv", index=False)
